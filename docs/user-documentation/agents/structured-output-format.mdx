...
description: "--- title: Structured output format excerpt: >- Structured output lets you constrain an agent's response to follow a specific JSON schema, ensuring co..."
---
...
```json structured output format example
