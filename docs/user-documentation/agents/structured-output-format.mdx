...
description: "* Open the agent builder * Click Advanced > Structured Response Format * Paste a valid JSON schema * Click Save The schema must follow this structure:..."
---
