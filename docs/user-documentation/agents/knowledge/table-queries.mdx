...
You can create Tables from API on existing Folders Data Sources. Please refer to our API documentation available here: [Upsert a table](/api-reference/post_api-v1-w-wid-spaces-spaceid-data-sources-dsid-tables)
