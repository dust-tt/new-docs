...
You can create Tables from API on existing Folders Data Sources. Please refer to our API documentation available here: [Upsert a table](/api-reference/datasources/upsert-a-table)
