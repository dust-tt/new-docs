...
You can create Tables from API on existing Folders Data Sources. Please refer to our API documentation available here: [Upsert a table](/docs/developer-platform/dust-api-documentation/openapi-and-postman)
