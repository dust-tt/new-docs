---
title: "Table queries"
description: "Table queries enable agents to generate and execute SQL queries on structured data before replying (Snowflake, BigQuery, CSVs, Notion Databases, Googl..."
---

Table queries enable agents to generate and execute SQL queries on structured data before replying (Snowflake, BigQuery, CSVs, Notion Databases, Google Sheets). 
...
<Image align="center" src="https://files.readme.io/2c6519f-Untitled_10.png" />
...
<Image align="center" src="https://files.readme.io/fdfb322-Screenshot_2024-07-01_at_10.31.58.png" />
...
3. Go to the `Tables` tab and click on `Add table`.
   ...
   <Image align="center" src="https://files.readme.io/b30bd68-Screenshot_2024-02-27_at_13.12.44.png" />
...
You can create Tables from API on existing Folders Data Sources. Please refer to our API documentation available here: [Upsert a table](https://docs.dust.tt/reference/post_api-v1-w-wid-spaces-spaceid-data-sources-dsid-tables)
