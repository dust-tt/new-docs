...
<Image
  align="center"
  alt="Sidekick panel proposing improvements to instructions"
  caption="Sidekick panel proposing improvements to instructions"
  src="https://files.readme.io/ab273fe-Untitled_6.png"
  width="600px"
/>
