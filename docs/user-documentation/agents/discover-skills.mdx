...
| :--- | :--- |
| Skill discovery | Reviews active workspace skills that are available for discovery, along with Dust-provided global skills. |
...
The agent only sees active skills that are available to it. Enabling Discover Skills does not bypass workspace or space permissions.
