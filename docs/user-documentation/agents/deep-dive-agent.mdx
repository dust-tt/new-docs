---
title: "Beta Deep Dive Agent For Comprehensive Work"
description: "--- title: '@deep-dive Agent' excerpt: >- Default agent to conduct comprehensive, in-depth analysis across all company data, databases, and web source..."
---
...
<Image align="center" border={true} caption="Asking `@deep-dive` to create a Frame about itself to understand how it's working :grinning:" src="https://files.readme.io/2a6a4b7de637897af3cb1b4b87c0ddb80fed666fbc7367a3144f3cafbdc97ea1-visualization-viz-fil_rICtlrKdpOp0LM.png" />
