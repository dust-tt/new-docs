...
description: "`@deep-dive` is a default agent in your workspace designed to tackle complex, multi-faceted questions that require thorough investigation. Unlike quic..."
---
