...
description: "--- title: Agent Builder Sidekick deprecated: false hidden: false metadata: robots: index --- Sidekick is an AI assistant built into the Agent Builder..."
---
...
# Creating an agent with Sidekick
