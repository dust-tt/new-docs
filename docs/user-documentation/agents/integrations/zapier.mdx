---
title: "Zapier"
description: "In this article, we will guide you through how to use the Dust block in Zapier to automatically trigger your Dust Agent from any other application. Cr..."
---
