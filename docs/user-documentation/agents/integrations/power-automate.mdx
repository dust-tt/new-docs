---
title: ":computer: Setup in Power Automate (admin only)"
description: "--- title: Power Automate excerpt: Talk to an agent or upload a file from your Power Automate workflows deprecated: false hidden: false metadata: robo..."
---

# :computer: Setup in Power Automate (admin only)
...
* **Power Platform Access**: get the _Power Automate Premium_ <Anchor label="license" target="_blank" href="https://www.microsoft.com/power-platform/products/power-automate/pricing">license</Anchor>
...
Download the latest version: <Anchor label="DustAssistantSolution.zip" target="_blank" href="https://office-addins.dust.tt/power-automate/PowerAutomate_DustAssistantSolution.zip">DustAssistantSolution.zip</Anchor>
...
* **Power Platform Access**: get the _Power Automate Premium_ <Anchor label="license" target="_blank" href="https://www.microsoft.com/power-platform/products/power-automate/pricing">license</Anchor>. Ask your admin to grant you a licence.
* **Dust Account**: Active Dust workspace with API access
* **API Credentials**: Create a Dust API key from your workspace settings
  1. _Log into Dust_*
     * Go to [dust.tt](https://dust.tt)
...
<Image align="center" border={false} width="500px" src="https://files.readme.io/0dda3c51a45d7793ad704485d701f29c0a6f1d2109bb6f8cd4a281ba64cf0633-image.png" />
...
<Tabs>
  <Tab title="'Talk to an Agent' Connector">
    <Image align="center" src="https://files.readme.io/3156290422f4cbc5f87520a81c820240d4248c36f3ac38ded6cb47a3fd448367-image.png" width="500px" />
  </Tab>

  <Tab title="'Upload Document' Connector">
    <Image align="center" src="https://files.readme.io/de37f136cdde57cc397d12069173f8413625d10947df3ed3c256317d7c9f858f-image.png" width="500px" />
  </Tab>
</Tabs>
