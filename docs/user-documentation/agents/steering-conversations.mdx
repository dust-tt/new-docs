---
title: "**What's new**"
description: "--- title: 'Steering: Conversations that keep up with you' excerpt: See every step as the agent works. Send a message mid-task and it adjusts. depreca..."
---
