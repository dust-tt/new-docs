...
For details on how programmatic usage draws from your workspace credit pool and what happens when credits are depleted, see [Credit Management](/docs/user-documentation/admins/usage-seats-and-credits/credit-management).
