---
title: "Filter webhooks payload"
description: "Dust can generate a filter with a Large Language Model to help you determine precisely which events should be triggering your agent, and create new co..."
---
...
4. **Use wildcards**: Leverage `.*` notation for arrays of objects instead of complex nested logic
