...
description: "The Google Sheets tool is deprecated. Migrate to the Google Drive tool, which supports reading and editing Google Sheets via tools like Get Spreadshee..."
---
