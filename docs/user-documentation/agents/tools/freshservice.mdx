---
title: "Freshservice"
description: "Connect Freshservice to Dust with a Freshservice Agent account and OAuth. Before you start: In **Freshservice** 1. Use a Freshservice account with the..."
---
...
4. Review the official documentation: [Dust Freshservice guide](https://docs.dust.tt/docs/freshservice) and [Freshservice authentication docs](https://api.freshservice.com/#authentication).
