...
description: "This tool interact with Microsoft Teams using the user's account: it adapts to each user. Go to Spaces > Tools in your Dust workspace, click `Add Tool..."
---
