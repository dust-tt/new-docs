---
title: "Attio Mcp"
description: "--- title: Attio excerpt: >- The Attio MCP is a hosted Model Context Protocol server by Attio that lets agents search, create, and update CRM data in..."
---
