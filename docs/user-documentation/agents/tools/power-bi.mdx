---
title: "Power Bi"
description: "--- title: Power BI excerpt: >- Power BI's Remote MCP Server lets your Dust assistants query semantic models, retrieve schemas, and execute DAX querie..."
---
...
Go to [app.fabric.microsoft.com](https://app.fabric.microsoft.com) → **Settings ⚙️ → Admin portal → Tenant settings → Integration settings**, and enable:
