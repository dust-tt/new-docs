---
title: "Run agent"
description: "The `run_agent` tool enables your agents to run other agent as a tool. Two modes of executions are available: The selected agent runs in a separate c..."
---
