---
title: "Airtable"
description: "--- title: Airtable excerpt: >- Airtable's MCP server lets your Dust assistants read and write records, explore base schemas, and interact with your A..."
---
...
<Callout icon="📖" theme="default">
  ...
  ### [Official Airtable OAuth documentation](https://airtable.com/developers/web/guides/oauth-integrations)
</Callout>
