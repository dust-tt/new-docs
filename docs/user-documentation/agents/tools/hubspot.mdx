...
See [Managing Tools](/docs/user-documentation/admins/tools-management) for details on how to make HubSpot tools available to your workspace. The setup will require authentication to HubSpot by the admin. Through the OAuth flow the admin will select that will be accessible by this integration.
