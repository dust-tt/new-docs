---
title: "HubSpot"
description: "HubSpot tools let you add to your agent the capability to interact with quite a few HubSpot objects. This lets you add to your agents the capability t..."
---
...
‼ **We highly recommend leaving any tool that can modify data in your CRM in HIGH STAKE** ‼
