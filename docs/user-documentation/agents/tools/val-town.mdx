---
title: "⭐ Key Features"
description: "--- title: Val Town excerpt: >- Tools to interact with Val Town's platform to write and scale serverless JavaScript.  deprecated: false hidden: false..."
---
...
<Cards columns={3}>
  ...
  <Card title="AI-Powered Development" icon="fa-brain">
...
Go to Spaces > Tools in your Dust workspace, click `Add Tools`, and select _Val Town_.
...
Your Val Town API token must be stored as a Dust developer secret. Go to Admin -> Builder Tools Management -> Secrets, and select _Create Secret_ to store your Val Town API token.
