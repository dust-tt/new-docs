...
description: "Dust agents can generate files from text content and convert files between different formats using the File Generation capability. This allows your ag..."
---
...
- For interactive data visualizations, consider using [Frames](https://docs.dust.tt/docs/frames) instead
