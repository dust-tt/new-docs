---
title: "Computer"
description: "Computer is a base capability of Dust agents. It gives an agent a safe, temporary workspace where it can run code, inspect files, create new files, pr..."
---
...
For admin setup instructions, see [Computer admin setup](././computer-admin).
...
For setup instructions, see [Computer admin setup](././computer-admin).
...
Computer is powerful, but it is still worth reviewing generated files. Keep these points in mind:
