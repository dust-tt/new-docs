...
<Tip>Iteration is key: If the first result isn't quite right, ask the agent to refine specific aspects. You can also use the generated image as a reference for the next iteration to build on what worked.</Tip>
For any questions about using Image Generation or Image Editing with your Dust agents, please contact us at support@dust.tt
```
