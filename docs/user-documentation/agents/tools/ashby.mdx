---
title: "Ashby"
description: "The Ashby MCP lets agents interact with your Ashby ATS workspace. It provides the ability to search for candidates and applications, retrieve job list..."
---
