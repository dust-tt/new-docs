---
title: "JIT tools (configure tools from the input bar)"
description: "With JIT tools, you can activate and configure tools directly from the conversation input bar when you need them—without editing the agent in the buil..."
---
