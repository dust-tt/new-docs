---
title: "Fathom Mcp"
description: "--- title: Fathom excerpt: >- Tools to list meetings and retrieve full transcripts from your Fathom workspace via Dust's built-in Fathom MCP server. d..."
---
