---
title: "Slack tools"
description: "On May 29, 2025, Slack implemented significant API and policy changes that affect third‑party integrations: - Marketplace requirement: commercial apps..."
---

<Callout type="danger"Warning>
</Callout>
...
<Callout icon="">
  ...
  **Another way to integrate Dust inside Slack**
  ...
  If you are looking to call Dust directly from Slack, please check [Dust in Slack](https://docs.dust.tt/docs/slack#/)
</Callout>
...
If you need actions to appear as coming from a bot rather than your personal account, see [Slack Bot MCP](././beta-slack-tool-using-bot-credentials) (available on request by contacting support@dust.tt).
