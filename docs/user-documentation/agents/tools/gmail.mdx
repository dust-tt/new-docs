---
title: "Gmail"
description: "The Gmail tool interacts with Gmail using each user's account, adapting to individual access permissions. <br /> <br /> Navigate to Spaces > Tools in..."
---

<Callout type="info"Personal credentials required>
</Callout>
...
<Image border={false} src="https://files.readme.io/a97f24f9918165029dc1164dc51b9513c615578ee9805e75e3a7cf075092eb7d-image.png" />
...
| **`send_mail`**          | Sends an email directly from Gmail _(new)_                                | High*       |
...
**Learn more about tool management and stake levels in the [Tools Management documentation](https://docs.dust.tt/docs/tools-management).**

** Email Reputation Warning**: Dust is not designed for bulk email campaigns. Using it for mass outreach can harm your domain's email reputation, affecting deliverability across your entire organization. Keep automation targeted and workflow-driven for best results.
