---
title: "⭐ Key Features"
description: "--- title: Jira excerpt: >- The Jira tool is a powerful integration that allows users to seamlessly manage Jira projects and issues directly from with..."
---
...
# :person_curly_hair:User : Usage in Dust
