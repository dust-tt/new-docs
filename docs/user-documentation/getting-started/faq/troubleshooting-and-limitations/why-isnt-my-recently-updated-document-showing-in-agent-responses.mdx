---
title: "Why isn't my recently updated document showing in agent responses?"
description: "If you updated a document but the agent isn't using the new information, here's how to diagnose: 1. Verify when the document was last updated 2. Check..."
---
...
See full limitations: [Connections Management - What kind of data cannot be read](/docs/managing-datasources#what-kind-of-data-cannot-be-read-by-my-agents)
