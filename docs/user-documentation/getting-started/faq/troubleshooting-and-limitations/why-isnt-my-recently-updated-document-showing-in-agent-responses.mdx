...
See full limitations: [Connections Management - What kind of data cannot be read](docs/user-documentation/admins/connections-management/index/#what-kind-of-data-cannot-be-read-by-my-agents)
