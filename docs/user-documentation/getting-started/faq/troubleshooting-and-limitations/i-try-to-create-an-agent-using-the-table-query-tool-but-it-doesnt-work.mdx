---
title: "I try to create an agent using the Table Query tool, but it doesn't work"
description: "The Table Query tool can't automatically create a relation between tables. You need to explicitly set the relationships in your instructions. Clearly..."
---
...
<Image align="center" width="600px" src="https://files.readme.io/db149b3-image.png" />
