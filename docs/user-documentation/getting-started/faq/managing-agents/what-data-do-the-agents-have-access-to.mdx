---
title: "What data do the agents have access to?"
description: "Dust only has access to data admins decided to synchronize with Dust. The agents can use: * Notion pages chosen by the admin. * Content from Slack cha..."
---
