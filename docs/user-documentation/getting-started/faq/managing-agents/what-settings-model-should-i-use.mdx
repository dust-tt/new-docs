...
description: "* **Instructions**: Write clear, detailed prompts for the agent. Check Prompting 101: How to Talk to Your Agents for more advice. * **Advanced**: Choo..."
---

* **Instructions**: Write clear, detailed prompts for the agent. Check [Prompting 101: How to Talk to Your Agents](././prompting-101-how-to-talk-to-your-agents) for more advice.
