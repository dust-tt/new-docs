...
description: "Audit Logs are only available to workspaces on the Enterprise plan. This page lists all events currently emitted by Dust. |---| | `agent.created` | An..."
---

<Callout type="info"**Enterprise feature.**>
</Callout>
