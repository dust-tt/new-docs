...
Welcome to Dust! If you are here, it's because you are an Admin of your workspace. As an Admin, you have all the privileges rights. See more about [Memberships & Roles](/docs/user-documentation/getting-started/dust-rollout-guide/admin-guide-set-up-your-dust-workspace).
