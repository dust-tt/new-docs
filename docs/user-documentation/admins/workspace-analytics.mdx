...
You can pull usage data programmatically through the [Export workspace analytics](/docs/developer-platform/dust-api-documentation/openapi-and-postman) endpoint. Any Dust API key with the **builder** role (or above) can call it — no special access request needed.
...
The previous [`workspace-usage`](/docs/developer-platform/dust-api-documentation/openapi-and-postman) endpoint is deprecated and will be removed after **2026-06-01**. Migrate to `analytics/export` before then.
</Danger>
