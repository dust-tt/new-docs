...
description: "Track adoption, credit consumption, and usage patterns across your workspace from **Admin > Analytics**. Only workspace admins can access this page. <..."
---
...
You can pull usage data programmatically through the [Export workspace analytics](https://docs.dust.tt/reference/get_api-v1-w-wid-analytics-export) endpoint. Any Dust API key with the **builder** role (or above) can call it — no special access request needed.
...
<Callout type="danger"**Legacy endpoint**>
</Callout>
The previous [`workspace-usage`](https://docs.dust.tt/reference/get_api-v1-w-wid-workspace-usage) endpoint is deprecated and will be removed after **2026-06-01**. Migrate to `analytics/export` before then.
