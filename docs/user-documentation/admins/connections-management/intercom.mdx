---
title: "Overview"
description: "--- title: Intercom excerpt: Set-up your Intercom Connection on Dust deprecated: false hidden: false metadata: title: '' description: '' robots: index..."
---
...
<Image align="center" width="300px" src="https://files.readme.io/b1be512-Screenshot_2024-02-15_at_15.48.27.png" />

Intercom Authorization popup.

<Image align="center" src="https://files.readme.io/93335f4-Screenshot_2024-02-15_at_15.52.05.png" />

Dust modal, to select the data you want to sync with your Dust workspace.

<Callout type="danger"Waiting time>
<Callout type="warning"We know the Permission modal is quite long to set up the first time you click on Save, we’re working on making it faster!>
</Callout>
# Sync of Conversations
