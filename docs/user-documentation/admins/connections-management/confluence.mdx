---
title: "Confluence"
description: "The initial user’s Confluence permissions bind the synchronization between Dust and Confluence. If permissions are edited by another user, the synchro..."
---
...
<Image alt="Confluence redirect to authorize and configure Dust." align="center" width="300px" src="https://files.readme.io/6a15506-Untitled_39.png">
  Confluence redirect to authorize and configure Dust.
</Image>

1. **Select Global Spaces**: During the connection setup, the admin can choose which global spaces in Confluence to synchronize with Dust. Only those selected will be accessible in Dust.

<Image alt="Dust modal to enable global spaces synchronization. " align="center" src="https://files.readme.io/2124f72-Untitled_40.png">
  Dust modal to enable global spaces synchronization.
</Image>

<Callout type="danger"About the admin user>
</Callout>
