---
title: "Overview"
description: "--- title: Snowflake excerpt: How to set-up your Dust Snowflake connection deprecated: false hidden: false metadata: title: '' description: '' robots:..."
---

# Overview

ℹ️ Dust does not synchronize or store any of your Snowflake data. We only store metadata, such as databases, schemas or tables names.

You can connect Dust to your Snowflake data warehouse to enable your agents to perform [Table queries](././table-queries) on your Snowflake tables.

Dust agents are able to use the output from these queries to answer quantitative questions:

<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/4ece47f861a7961b68fd9f3ec9568bea1b4ef991f758c6882e4501e375e364b2-Screenshot_2024-10-17_at_12.24.45.png" />

The agents can also leverage the results to create visualizations, such as charts:

<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/e2df019c1de6c8b386ff9df7b107311793a40a67482b355883774a0828fb3318-Screenshot_2024-10-17_at_12.26.11.png" />

The "Tools inspection" button allows to view the reasoning and SQL query used by the agent to retrieve the data:

<Image align="center" className="border" width="75% " border={true} src="https://files.readme.io/af56babf45529b4891881a8fd90ebb64365775de8e23f46b73379efc3fb6715d-Screenshot_2024-10-17_at_15.24.32.png" />
...
<Callout type="info"We recommend creating a dedicated Warehouse, User and Role for Dust.>
</Callout>
...
Replace 'strong_password' with a secure, unique password.
...
<Callout type="info"About permissions for the dust\_role>
</Callout>
...
<Image align="center" className="border" width="40% " border={true} src="https://files.readme.io/b749c2b6993fd0f3bc04526e41abbdb0384a8dae164df03a5b76c2a557b58828-Screenshot_2024-10-17_at_15.13.14.png" />
