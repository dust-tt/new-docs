---
title: "Snowflake"
description: "ℹ️ Dust does not synchronize or store any of your Snowflake data. We only store metadata, such as databases, schemas or tables names. You can connect..."
---
