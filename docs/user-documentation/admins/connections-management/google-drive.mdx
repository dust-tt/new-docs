---
title: "Overview"
description: "--- title: Google Drive excerpt: How to set-up the Google Drive connection on Dust deprecated: false hidden: false metadata: title: '' description: ''..."
---

<Callout type="danger"Recommended method>
</Callout>
...
<Image align="center" width="300px" src="https://files.readme.io/b1a75d8-Screenshot_2024-02-23_at_10.08.15.png" />

1. Google Authorization Acknowledgment

<Image align="center" width="300px" src="https://files.readme.io/3d0c340-Untitled_20.png" />

2. Google Sign in modal

<Image align="center" width="200px" src="https://files.readme.io/119a80c-Untitled_21.png" />

3. Google Authorization modal

4. A modal to select the exact data you want to sync with Dust.

<Image align="center" src="https://files.readme.io/2eeedcf-Untitled_22.png" />
...
* ⚠️ **The email address used to manage permissions should have edition & download rights** on the desired documents to allow them to be read by Dust.
...
<Callout type="info"Custom labels support was added June 13 2025>
</Callout>
