---
title: "Google Drive"
description: "The recommended approach to creating a Google Drive Connection is to provision a user dust-admin@yourdomain.com in your Google workspace and use that..."
---
