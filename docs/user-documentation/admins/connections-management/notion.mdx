---
title: "Notion"
description: "Ensure to do the Initial Connection Setup once and then Manage the Connection by adding or unselecting pages directly from Notion. The recommended app..."
---

<Callout type="danger"Heads up>
</Callout>
...
<Callout type="info"User provisionning>
</Callout>
...
<Image align="center" alt="Notion Authorization popup." caption="Notion Authorization popup." src="https://files.readme.io/b1b8a49-Untitled_34.png" width="300px" />

<Image align="center" alt="Notion modal, to select the data you want to sync with your Dust workspace." caption="Notion modal, to select the data you want to sync with your Dust workspace." src="https://files.readme.io/db4b0ab-Untitled_35.png" width="300px" />
...
<Callout type="danger"Permissions>
</Callout>
...
<Image align="center" src="https://files.readme.io/69fe416-Untitled_36.png" />

<Callout type="danger"Missing pages>
<Callout type="danger"Notion API isn't designed to ease sync with 3rd parties; some pages you think should be indexed can be missing.>
</Callout>
...
<Image align="center" src="https://files.readme.io/4af8940-Untitled_37.png" />
...
<Callout type="danger"Large workspaces>
</Callout>
...
<Image align="center" src="https://files.readme.io/e9a634e-Screenshot_from_2024-03-06_14-14-10.png" />

<Image align="center" src="https://files.readme.io/ef887c4-Untitled_38.png" />
...
From Notion, select the `...` option (top right), then choose `Connect to` and select `Dust`. Read [the guide here](https://docs.dust.tt/docs/notion-connection#updating-the-connection).
...
<Callout type="info"Labels support was added Feb 13 2025>
</Callout>
