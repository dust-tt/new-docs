---
title: "BigQuery"
description: "ℹ️ Dust does not synchronize or store any of your BigQuery data. We only store metadata, such as datasets and table names. You can connect Dust to you..."
---
