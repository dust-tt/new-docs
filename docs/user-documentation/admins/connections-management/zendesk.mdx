---
title: "Overview"
description: "--- title: Zendesk excerpt: Set-up your Zendesk Connection on Dust deprecated: false hidden: false metadata: title: '' description: '' robots: index n..."
---
...
<Callout type="info"Zendesk extension>
</Callout>
We also have a Dust extension available on the Zendesk marketplace that enables access to Dust agents by your support team directly within Zendesk. Check out the documentation at [Zendesk extension](././zendesk).

# Searching for our Zendesk app?

This page talks about importing Zendesk data to Dust. If you want to install the Dust Zendesk app, please visit this article: [Dust in Zendesk](././zendesk)
...
<Image align="center" border={true} width="30% " src="https://files.readme.io/97a6a86a5c870bfbd158c0ed6247b1f9bf6709fc5d412ffe36b61172fd81ddd8-Screenshot_2024-11-28_at_11.14.59_AM.png" className="border" />
...
<Image align="center" border={true} width="70% " src="https://files.readme.io/04105a09e548a2224a4f6adaae25cc415856ff34ade7a61a083b6ce9dabffb4c-Screenshot_2025-02-24_at_3.42.26_PM.png" className="border" />

Dust modal to select the data you want to sync with your Dust workspace.

<Callout type="info"How to check if you are an admin in Zendesk>
</Callout>
...
<Image align="center" width="50% " src="https://files.readme.io/323c28c467099af9ae9a8f354bc2a3cd756fda1a115f008bc01b77870ef0cc2c-Screenshot_2026-02-20_at_1.33.01_PM.png" />
...
Configure custom Zendesk ticket fields to be included as tags when syncing tickets. Custom field values will be added as labels in the format `fieldName:value`, making them available for filtering in Dust's [semantic search](https://docs.dust.tt/docs/search-your-data) tool.
...
<Callout type="danger"Quantitative use-cases>
</Callout>
...
<Callout type="info"Hiding names and email addresses>
</Callout>
