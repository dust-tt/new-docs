...
description: "This page explains how workspace admins can configure Computer. For an overview of what Computer does for users and builders, see Computer. The Comput..."
---

This page explains how workspace admins can configure Computer. For an overview of what Computer does for users and builders, see [Computer](././computer).
