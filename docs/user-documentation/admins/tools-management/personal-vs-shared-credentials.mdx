...
description: "When adding tools that require authentication (like GitHub, HubSpot, or remote MCP servers), you have two credential configuration options. Understand..."
---
