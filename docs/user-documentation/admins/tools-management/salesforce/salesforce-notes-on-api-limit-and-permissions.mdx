...
description: "1. You ask a question in plain language (like \"Give me an account summary of xx\" or \"What's the pipeline for this quarter?\"). 2. The agent translates..."
---
...
See how [access controls and space permissions](https://docs.dust.tt/docs/access-controls-and-permissions) work in Dust.
...
* Salesforce data is available through the tool "[Query Tables](https://docs.dust.tt/docs/table-queries)" in the Agent Builder.
* Note that not all fields are automatically queryable - they may need to be made accessible in your Salesforce configuration first - see [**Dust Salesforce Connection Setup**](https://www.notion.so/Dust-Salesforce-Connection-Setup-1b528599d9418080b0bafd96f30f50e2?pvs=21)
