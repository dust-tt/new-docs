...
description: "--- title: Adding an MCP Server excerpt: >- Extending Dust's toolset beyond the default list of tools is possible by adding extra MCP Servers. Multipl..."
---
...
<Image align="center" alt="The interface to add an MCP server" caption="The interface to add an MCP server" src="https://files.readme.io/afcfa686246be2d7c851c4057618305c59be36e88b53093303b635fcad4530b4-Capture_decran_2025-04-16_a_09.36.23.png" width="600px" />
...
* **[Attio MCP](https://docs.dust.tt/docs/attio)** — URL: `https://mcp.attio.com/mcp` (OAuth) — Search, create, and update CRM data in your Attio workspace.
...
<Image align="center" width="400px" src="https://files.readme.io/675f22fe0a99c17d32d31efa8f0d398707910cfde0e5e524ee2fbbfac65e642b-image.png" />
