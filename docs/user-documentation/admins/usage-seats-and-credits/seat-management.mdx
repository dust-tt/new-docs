...
description: "--- title: Seat management excerpt: Understand seat types and how to manage them in your Dust workspace. deprecated: false hidden: false metadata: tit..."
---
