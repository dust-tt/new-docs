...
description: "Seats control each workspace member's AI usage capacity. Every member has two independent attributes: a **role** (what they can configure and access —..."
---

Seats control each workspace member's AI usage capacity. Every member has two independent attributes: a **role** (what they can configure and access — see [Memberships & Roles](./../users-permissions-management/setting-up-your-workspace)) and a **seat type** (their credit allocation).
...
For details on how credits work, see [Credits](./credits).
