...
[Go Deep](/docs/user-documentation/agents/go-deep) gives agents the ability to conduct comprehensive research across company data, databases, and web sources. It includes sub-agents, company data exploration, data warehouse queries, and web search and browsing.
