...
description: "--- title: Credit management excerpt: >- How credit consumption works across individual credits, workspace pools, programmatic usage, and how to track..."
---

Credits are the unit of AI work on Dust — see [Credits](./credits) for how they're calculated and what each seat type includes.
...
1. **Individual credits** — from the user's seat credit pool (see [Credits](./credits))
...
<Callout type="info"Free seat users only have individual credits. They cannot draw from the workspace pool and are blocked once their 500 lifetime credits are exhausted.>
</Callout>
...
# Per-user pool access limits (personal spend limit)
...
For a broader view of how your team uses Dust — agent activity, conversation trends, and adoption over time — see [Workspace analytics](././workspace-analytics).
