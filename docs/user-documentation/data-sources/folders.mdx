...
Both file types can be automatically pushed to a folder using the [Dust API](/api-reference/developer-platform-overview) or using the [Zapier integration](/docs/user-documentation/data-sources/custom-connections/zapier-automatically-add-datasource). Learn more about it in [Custom connections](/docs/user-documentation/data-sources/overview).
