...
* In the `Account`tab, **follow the instructions to connect Zapier with your Dust account:** you will need your **Workspace ID** (which can be found in your Dust tab URL, right after *dust.tt/w/*), as well as your **Dust API key**, which a workspace admin can create from **API & Programmatic > API Keys > Create an API Key**\
