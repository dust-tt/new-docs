---
title: "[Beta] Import Front Conversations"
description: "This open-source script, available on GitHub at dust-tt/dust-labs/front automates the process of exporting your Front conversations and importing them..."
---

This open-source script, available on GitHub at [dust-tt/dust-labs/front](https://github.com/dust-tt/dust-labs/tree/main/front) automates the process of exporting your Front conversations and importing them into a Dust datasource. It preserves comprehensive conversation data and metadata, like so:
