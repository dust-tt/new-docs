---
title: "Client Side MCP Server (Preview)"
description: "Client-side MCP server enables you to dynamically expose tools to Dust conversations through your client applications that interact with Dust's Conver..."
---
