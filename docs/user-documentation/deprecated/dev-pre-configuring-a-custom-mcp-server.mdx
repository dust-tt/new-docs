---
title: "Dev : pre-configuring a custom MCP server"
description: "<br /> When doing regular function calling the agent exposes to the LLM what parameters the function needs through a schema. The LLM then answers with..."
---
...
<Image align="center" border={false} width="60% " src="https://files.readme.io/11f87e139058fef0924101db73fb2ea6da961ef20623706f77f3fb09821d8f21-Screenshot_2025-04-15_at_6.28.05_PM.png" />
