---
title: "Pods Conversations"
description: "--- title: Conversations hidden: false metadata: robots: noindex --- The **Conversations tab** lists all conversations created inside the Pod. Every P..."
---
...
<Callout type="info"Every conversation in a Pod is automatically indexed. Agents can search and reference past conversations as context, without you doing anything.>
</Callout>
## Mentioning people
...
<Callout type="info"The Pods skill is available to all agents by default, including the global Dust agent, agents invoked inside a Pod, and triggered agents.>
</Callout>
...
<Image align="center" border={true} src="https://files.readme.io/f0600811805ad9b4b103cdd1dcbf589137020f5d8faf4a9f2b6dd77ba79082e2-image.png" className="border" />
