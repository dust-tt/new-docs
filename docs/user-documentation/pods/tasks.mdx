...
This reflects a core principle of Pods: **everything a human can do, an agent can do**. Agent interactions with Tasks are powered by the **Pods skill**, which is available to all agents by default. See the [Overview](/docs/user-documentation/pods/overview) for more details.
