---
title: "What is Dust?"
description: "--- title: Overview excerpt: What is Dust and how to use the platform deprecated: false hidden: true metadata: title: '' description: '' robots: index..."
---
...
Go to ️**Admin > Connections > Select** the desired Connection, click **Connect > Authenticate your account**, and select the data you wish to synchronize with Dust.
...
* To call other assistants, use the syntax **@dust ~gpt4** OR **@dust** **+gpt4** and your question to engage with @gpt4 for example (change `gpt4` to `any company assistant name` to interact with it!) ⬇️
