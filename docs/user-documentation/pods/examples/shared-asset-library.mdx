---
title: "Pods Example Shared Assets"
description: "--- title: Shared asset library hidden: false metadata: robots: noindex --- **Audience:** Design, Brand, and Platform teams **Goal:** Centralise logos..."
---
