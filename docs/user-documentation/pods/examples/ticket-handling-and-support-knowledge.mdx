---
title: "Ticket handling and support knowledge"
description: "**Audience:** Support / Ops **Goal:** Automatically create one task per incoming ticket, let agents start resolving them, and build a collective memor..."
---
