...
* Frontier model assistants use the latest large models to handle a wide range of tasks like text, summarization, translation, etc.
...
You interact with Dust assistants through "conversations" where you ask questions/make requests, and the assistants respond using available data. Sharing conversation links allows all workspace members to collaborate on the same conversation.
