...
<Info>
**Billing note:** Interactive CLI chat (typing in the terminal UI) counts as regular human usage. Non-interactive messages (`--message`) count as [programmatic usage](https://docs.dust.tt/docs/programmatic-usage) and consume credits.
</Info>
